    ...
    public class XL_HangHoa
    {
        ...
        public int ThemHangHoa(HangHoa hh)
        {
            ...
            string sql = string.Format("insert into HANGHOA values" +
                ...
                hh.XuatXu, hh.TonKhoToiThieu, hh.TonHienTai, hh.NCC, hh.GiaMua, hh.GiaBanLe, hh.GiaBanSi, cql);
        ...
        public int CapNhatHangHoa(HangHoa hh)
        {
            ...
            string sql = string.Format("update HANGHOA set " +
                ...
                hh.LoaiHangHoa, hh.KhoMacDinh, hh.PhanLoai, hh.MaVachNSX, hh.TenHang, hh.DonVi, hh.XuatXu, hh.TonKhoToiThieu, hh.TonHienTai, hh.NCC, hh.GiaMua, hh.GiaBanLe, hh.GiaBanSi, cql, hh.MaHangHoa);
