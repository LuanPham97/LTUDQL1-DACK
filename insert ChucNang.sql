...
--			insert into CHUCNANG(MaChucNang, TenChucNang, MaCha) values(12, N'Vai Trò & Quyền Hạn', 8)
		...
		insert into CHUCNANG(MaChucNang, TenChucNang, MaCha, TenTrongHeThong) values(9, N'Đổi Mật Khẩu', 5,'btnDoiMatKhau')
		insert into CHUCNANG(MaChucNang, TenChucNang, MaCha, TenTrongHeThong) values(10, N'Nhật Ký Hệ Thống', 5,'btnNhatKy')

	insert into CHUCNANG(MaChucNang, TenChucNang, MaCha, TenTrongHeThong) values(6, N'Dữ Liệu', 1,'rpgDuLieu')
		insert into CHUCNANG(MaChucNang, TenChucNang, MaCha,TenTrongHeThong) values(13, N'Sao Lưu', 6,'btnSaoLuu')
		insert into CHUCNANG(MaChucNang, TenChucNang, MaCha,TenTrongHeThong) values(14, N'Phục Hồi', 6,'btnPhucHoi')
...
insert into CHUCNANG(MaChucNang, TenChucNang, TenTrongHeThong) values(2, N'Danh Mục', 'rbpDanhMuc')
	insert into CHUCNANG(MaChucNang, TenChucNang, MaCha, TenTrongHeThong) values(17, N'Đối Tác', 2, 'rpgDoiTac')
		insert into CHUCNANG(MaChucNang, TenChucNang, MaCha, TenTrongHeThong) values(20, N'Khu Vực', 17,'btnKhuVuc')
		insert into CHUCNANG(MaChucNang, TenChucNang, MaCha, TenTrongHeThong) values(21, N'Khách Hàng', 17, 'btnKhachHang')
		insert into CHUCNANG(MaChucNang, TenChucNang, MaCha, TenTrongHeThong) values(22, N'Nhà Phân Phối', 17,'btnKhuVuc')
...
--	insert into CHUCNANG(MaChucNang, TenChucNang, MaCha, TenTrongHeThong) values(18, N'Kho Hàng', 2, 'rpgKhoHang')
		...
		insert into CHUCNANG(MaChucNang, TenChucNang, MaCha, TenTrongHeThong) values(24, N'Đơn Vị', 18,'btnDonViTinh')
		insert into CHUCNANG(MaChucNang, TenChucNang, MaCha, TenTrongHeThong) values(25, N'Nhóm Hàng', 18,'btnNhomHang')
...
--		insert into CHUCNANG(MaChucNang, TenChucNang, MaCha) values(27, N'In Mã Vạch', 18)
	insert into CHUCNANG(MaChucNang, TenChucNang, MaCha, TenTrongHeThong) values(28, N'Tỷ Giá', 18,'btnTyGia')
--	insert into CHUCNANG(MaChucNang, TenChucNang, MaCha) values(29, N'Quy Đổi Đơn Vị', 18)

	insert into CHUCNANG(MaChucNang, TenChucNang, MaCha, TenTrongHeThong) values(19, N'Tổ Chức', 2,'rpgToChuc')
		insert into CHUCNANG(MaChucNang, TenChucNang, MaCha, TenTrongHeThong) values(30, N'Bộ Phận', 19,'btnBoPhan')
	insert into CHUCNANG(MaChucNang, TenChucNang, MaCha, TenTrongHeThong) values(31, N'Nhân Viên', 19,'btnNhanVien')
...
--		insert into CHUCNANG(MaChucNang, TenChucNang, MaCha) values(44, N'Trả Tiền', 33)
	...
	insert into CHUCNANG(MaChucNang, TenChucNang, MaCha, TenTrongHeThong) values(34, N'Kho Hàng', 3,'rpgKhoHangcn')
		insert into CHUCNANG(MaChucNang, TenChucNang, MaCha, TenTrongHeThong) values(45, N'Chuyển Kho', 34,'btnChuyenKho')
		--insert into CHUCNANG(MaChucNang, TenChucNang, MaCha, TenTrongHeThong) values(46, N'Xuất Kho', 34)
		insert into CHUCNANG(MaChucNang, TenChucNang, MaCha, TenTrongHeThong) values(47, N'Tồn Kho', 34,'btnTonKho')
